...
------------------------------------------------------------
Description :
    Vérification d'environnement — APP4 VVDR (V&V Decision Record).

Rôle :
    - Collecter des informations de santé environnement (Python, pip,
      venv, OS, chemins projet)
    - Produire une preuve exploitable (Markdown) pour validation environnement
      (portfolio / audits / entretiens)
...
Notes :
    ...
    - Script déterministe (no network).
============================================================
"""
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="APP4 VVDR - Environment healthcheck")
